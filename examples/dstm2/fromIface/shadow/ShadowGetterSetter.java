...
public class ShadowGetterSetter<interface Y> extends Adaptor<Y> implements Releasable {
    ...
    <F4>[f4] for ( F4 get#f4() : Y.methods; some set#f4(F4) : Y.methods ;
		 error some get#f4() : Object.methods ;
		 error some F4 f4 : DefaultImplementation<AtomicBase<Y>,Y>.fields 
		 ) {|    
    public F4 get#f4() {
	try {
            Transaction me  = Thread.getTransaction();
