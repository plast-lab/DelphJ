...
import examples.dstm2.exceptions.GracefulException;
 ...
 * begun.
 *
 * @see examples.dstm2.ContentionManager
 */
public class Thread extends java.lang.Thread {
   ...
   * Adapter class.
   */
    //  protected static Class<examples.dstm2.factory.Adapter> adapterClass;
  ...
  public static void setContentionManagerClass(Class theClass) {
    Class cm;
    try {
      cm = Class.forName("examples.dstm2.ContentionManager");
    ...
    try {
      ...
      throw new PanicException("The class " + theClass
          + " does not implement examples.dstm2.ContentionManager");
    }
  }
  ...
  public static void setAdapterClass(String adapterClassName) {
    try {
      adapterClass = (Class<examples.dstm2.factory.Adapter>)Class.forName(adapterClassName);
