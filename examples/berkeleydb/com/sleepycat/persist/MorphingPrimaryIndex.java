 ...
 * @author Mark Hayes
 */
public class MorphingPrimaryIndex<PK,E> extends BasicIndex<PK,E> {
     ...
     */
    public MorphingPrimaryIndex(Database database,
				Class<PK> keyClass,
	...
	// The usefulness of keyClass is suspect here.
        ...
        if (entityBinding instanceof MorphingPersistEntityBinding) {
            keyAssigner =
                ((MorphingPersistEntityBinding) entityBinding).getKeyAssigner();
        }
    }
